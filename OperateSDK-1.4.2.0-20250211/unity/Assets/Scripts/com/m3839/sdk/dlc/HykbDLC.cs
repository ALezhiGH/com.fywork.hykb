...
namespace com.m3839.sdk.dlc
{
    ...
    public class HykbDLC
    {
        ...
        /// </summary>
        /// <param name="listener"></param>
        public static void exchange(int skuId, string code, HykbDLCExchangeListener listener)
        {
            getDLCClass().CallStatic("exchange", HykbContext.GetInstance().GetActivity(), skuId, code, listener);
        }
        ...
        /// </summary>
        /// <param name="listener"></param>
        public static void queryAll(HykbDLCQueryAllListener listener)
        {
            getDLCClass().CallStatic("queryAll", HykbContext.GetInstance().GetActivity(), listener);
        }
